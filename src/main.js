...
canvas.registerFont(__dirname + '/Fonts/nerd.ttf', {
  family: 'jetbrains',
});
...
//CREDITS: https://github.com/Shamil-FD/ToastyXD/blob/master/src/Util/Functions.js
//sorry shamil xd
client.captcha = async function () {
